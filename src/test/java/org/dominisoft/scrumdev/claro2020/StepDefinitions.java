...
public final class StepDefinitions {
  ...
  public void iClickOnElement(String el) {
    final WebElement element = driver.findElement(By.id(el));
    element.click();
  }
  ...
  public void theInputXShouldNotBeY(String input, String value) {
    final WebElement element = driver.findElement(By.id(input));
  ...
  public void theLabelXShouldHaveTextY(String label, String text) {
    final WebElement element = driver.findElement(By.id(label));
  ...
  public void should_display_Invalid_Loggin_message() {
    final String value = driver.findElement(By.id("error-msg")).getAttribute("innerText");
